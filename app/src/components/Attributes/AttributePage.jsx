...
const AttributePage = ({ url }) => {
    ...
    const physicalData = filterKeysFromArray(data[0], physicalKeys);
    const mentalData = filterKeysFromArray(data[0], mentalKeys);
    const technicalData = filterKeysFromArray(data[0], technicalKeys);
    const keeperData = filterKeysFromArray(data[0], keeperKeys);
