...
export default () => {
  ...
  useRedirectIfUnauthed('/', {
    roles: ['PT_GRADER', 'SHL_HO', 'SMJHL_HO'],
  });
    ...
    <PageWrapper loading={false}>
      <div className="flex items-center justify-center">
        <div className="my-4 flex w-11/12 flex-col space-y-4 lg:w-3/5">
          ...
          <RoleGuard userRoles={['PT_GRADER', 'SHL_HO', 'SMJHL_HO']}>
            <Tabs isLazy>
              <TabList>
                <Tab>Submission</Tab>
                <Tab>Reporting</Tab>
                ...
                <TabPanel>
                  <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-3">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        name="playerGroup"
                        onChange={(e) =>
                          changePlayerType(e.currentTarget.value)
                        }
                      >
                  ...
                  {parsedSubmissionData.hasDuplicates && (
                    <div className="my-4 text-center">
                      <Text color="red">
                        There are duplicate records that need to be resolved
                  ...
                  <Divider />
                  <div className="mb-4 bg-grey900 p-4 text-grey100">
                    Eligible Players
                  </div>
                  <PlayerTable
                    data={data}
