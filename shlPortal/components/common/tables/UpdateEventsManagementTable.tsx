            ...
            return (
              <div className="space-x-2">
                <Button
                  ...
                  isLoading={currentlyProcessing.denials.includes(cellEventID)}
                >
                  Deny
                </Button>
                <Button
                  ...
                  isDisabled={currentlyProcessing.denials.includes(cellEventID)}
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            >
              <option
                selected={season + 1 === selectedSeason}
                value={season + 1}
              >
                S{season + 1}
              </option>
              <option
                selected={season + 2 === selectedSeason}
                value={season + 2}
              >
                S{season + 2}
              </option>
