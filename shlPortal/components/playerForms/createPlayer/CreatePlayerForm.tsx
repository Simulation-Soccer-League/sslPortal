    ...
    <form onSubmit={onSubmit}>
      <div className="flex items-center justify-center">
        <div className="flex w-11/12 flex-col lg:w-3/5">
          ...
          <div className="bg-grey900 p-2 text-grey100">Attributes</div>
            ...
            <ModalBody>
              {!isEmpty(errors) ? (
                ...
                >
                  ...
                  Are you sure you would like to submit your current player to
                  the SMJHL interns to be approved? Please review your
                  player&apos;s build below.
                </BasicPlayerSheet>
              )}
            </ModalBody>
            <ModalFooter>
